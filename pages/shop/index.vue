      ...
      <div class="container">
        <div class="flex lg:gap-8">
          <aside class="lg:w-1/4 mb-6 md:">
            ...
            >
              <div
                class="lg:invisible lg:hidden flex items-center p-4 justify-between"
              >
          ...
          <section class="lg:w-3/4 w-full">
            ...
            <div
              ...
              class="relative flex flex-col min-w-0 rounded-lg break-words bg-gray-100 p-8 mb-6"
            >
              <!-- card body -->
              <div class="flex-auto">
                <h1 class="text-xl">
                  ...
                  <div class="flex flex-col gap-3">
                    ...
                    <div class="flex justify-between items-center">
                      <div>
                        ...
                        >
                        <span
                          v-if="product.sale_price != product.reguler_price"
                          class="line-through text-gray-500"
                          >Rp. {{ formatPrice(product.reguler_price) }}</span
                        >
                      </div>
                      <div>
                        <button
...
onMounted(async () => {
  ...
  const responseCat = await categoryStore.fetchCategoriesShop();

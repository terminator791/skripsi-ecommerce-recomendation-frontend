  ...
  >
    <div class="flex-auto p-4">
      <div class="text-center relative flex justify-center">
        <div
          v-if="product.reguler_price != product.sale_price"
        ...
        <NuxtLink :to="`/shop/${product.id}`">
          <img
            :src="product.product_image || '/images/no-image-placeholder.png'"
      ...
      <div class="flex flex-col gap-3">
        <NuxtLink
          :to="`/shop/${product.id}`"
          class="text-decoration-none text-gray-500"
          ><small>{{ product.category_name }}</small></NuxtLink
        >

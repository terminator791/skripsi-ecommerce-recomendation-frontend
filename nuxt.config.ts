...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      apiUserBaseUrl:
        process.env.NUXT_USER_API_BASE_URL ?? "http://localhost:8090",
      apiOrderBaseUrl:
        process.env.NUXT_ORDER_API_BASE_URL ?? "http://localhost:8083",
      apiProductBaseUrl:
        process.env.NUXT_PRODUCT_API_BASE_URL ?? "http://localhost:8082",
      apiPaymentBaseUrl:
